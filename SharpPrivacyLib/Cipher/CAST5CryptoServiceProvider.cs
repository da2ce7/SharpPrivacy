...
// 	CSP for encrypting using the CAST5 cipher.
//
// Most parts of this code rely on portions of the GnuPG implemenation
...
namespace SharpPrivacy.SharpPrivacyLib.Cipher {
	...
	/// <remarks>
	/// 	created by - df
	/// 	created on - 07.01.2003 22:19:07
	/// </remarks>
	public sealed class CAST5CryptoServiceProvider : CAST5 {
	
		public CAST5CryptoServiceProvider() {}
		...
		public override ICryptoTransform CreateDecryptor(byte[] rgbKey, byte[] rgbIV) {
			Key = rgbKey;
			IV = rgbIV;
			return new CAST5Transform(this, false);
		}
	
		public override ICryptoTransform CreateEncryptor(byte[] rgbKey, byte[] rgbIV) {
			Key = rgbKey;
			IV = rgbIV;
			return new CAST5Transform(this, true);
		}
	...
	internal class CAST5Transform : SymmetricTransform {
		
		private CAST5 baseClass;
		private CAST5_context c;
		...
		protected override void ECB(byte[] input, byte[] output) {
			byte[] bTmpOutput;
			if (this.encrypt)
				bTmpOutput = encrypt_block(ref c, input);
			else
				bTmpOutput = decrypt_block(ref c, input);
			
			Array.Copy(bTmpOutput, output, output.Length);
			return;
		}
		
		
		private struct CAST5_context {
			public uint[] Km;
			public byte[] Kr;
		};
		...
		private static uint rol(byte n, uint x) {
			return (x << n) | (x >> (32-n));
		}
		
		private static uint F1(uint D, uint m, byte r) {
			uint I = m + D;
			I = rol(r, I);
			return ((s1[I >> 24] ^ s2[(I>>16)&0xff]) - s3[(I>>8)&0xff]) + s4[I&0xff];
		}
		
		private static uint F2(uint D, uint m, byte r) {
			uint I = m ^ D;
			I = rol(r, I);
			return ((s1[I >> 24] - s2[(I>>16)&0xff]) + s3[(I>>8)&0xff]) ^ s4[I&0xff];
		}
		
		private static uint F3(uint D, uint m, byte r) {
			uint I = m - D;
			I = rol(r, I);
			return ((s1[I >> 24] + s2[(I>>16)&0xff]) ^ s3[(I>>8)&0xff]) - s4[I&0xff];
		}
		
		private static uint xi(byte i, uint[] x) {
			return ((x[(i)/4] >> (8*(3-((i)%4)))) & 0xff);
		}
		
		private static uint zi(byte i, uint[] z) {
			return ((z[(i)/4] >> (8*(3-((i)%4)))) & 0xff);
		}
		
		private static void burn_stack(int bytes) {
		...
		private static void key_schedule(uint[] x, uint[] z, uint[] k) {
			z[0] = x[0] ^ s5[xi(13, x)]^s6[xi(15, x)]^s7[xi(12, x)]^s8[xi(14, x)]^s7[xi( 8, x)];
			z[1] = x[2] ^ s5[zi( 0, z)]^s6[zi( 2, z)]^s7[zi( 1, z)]^s8[zi( 3, z)]^s8[xi(10, x)];
			z[2] = x[3] ^ s5[zi( 7, z)]^s6[zi( 6, z)]^s7[zi( 5, z)]^s8[zi( 4, z)]^s5[xi( 9, x)];
			z[3] = x[1] ^ s5[zi(10, z)]^s6[zi( 9, z)]^s7[zi(11, z)]^s8[zi( 8, z)]^s6[xi(11, x)];
			k[0] = s5[zi( 8, z)]^s6[zi( 9, z)]^s7[zi( 7, z)]^s8[zi( 6, z)]^s5[zi( 2, z)];
			k[1] = s5[zi(10, z)]^s6[zi(11, z)]^s7[zi( 5, z)]^s8[zi( 4, z)]^s6[zi( 6, z)];
			k[2] = s5[zi(12, z)]^s6[zi(13, z)]^s7[zi( 3, z)]^s8[zi( 2, z)]^s7[zi( 9, z)];
			k[3] = s5[zi(14, z)]^s6[zi(15, z)]^s7[zi( 1, z)]^s8[zi( 0, z)]^s8[zi(12, z)];
			
			x[0] = z[2] ^ s5[zi( 5, z)]^s6[zi( 7, z)]^s7[zi( 4, z)]^s8[zi( 6, z)]^s7[zi( 0, z)];
			x[1] = z[0] ^ s5[xi( 0, x)]^s6[xi( 2, x)]^s7[xi( 1, x)]^s8[xi( 3, x)]^s8[zi( 2, z)];
			x[2] = z[1] ^ s5[xi( 7, x)]^s6[xi( 6, x)]^s7[xi( 5, x)]^s8[xi( 4, x)]^s5[zi( 1, z)];
			x[3] = z[3] ^ s5[xi(10, x)]^s6[xi( 9, x)]^s7[xi(11, x)]^s8[xi( 8, x)]^s6[zi( 3, z)];
			k[4] = s5[xi( 3, x)]^s6[xi( 2, x)]^s7[xi(12, x)]^s8[xi(13, x)]^s5[xi( 8, x)];
			k[5] = s5[xi( 1, x)]^s6[xi( 0, x)]^s7[xi(14, x)]^s8[xi(15, x)]^s6[xi(13, x)];
			k[6] = s5[xi( 7, x)]^s6[xi( 6, x)]^s7[xi( 8, x)]^s8[xi( 9, x)]^s7[xi( 3, x)];
			k[7] = s5[xi( 5, x)]^s6[xi( 4, x)]^s7[xi(10, x)]^s8[xi(11, x)]^s8[xi( 7, x)];
			
			z[0] = x[0] ^ s5[xi(13, x)]^s6[xi(15, x)]^s7[xi(12, x)]^s8[xi(14, x)]^s7[xi( 8, x)];
			z[1] = x[2] ^ s5[zi( 0, z)]^s6[zi( 2, z)]^s7[zi( 1, z)]^s8[zi( 3, z)]^s8[xi(10, x)];
			z[2] = x[3] ^ s5[zi( 7, z)]^s6[zi( 6, z)]^s7[zi( 5, z)]^s8[zi( 4, z)]^s5[xi( 9, x)];
			z[3] = x[1] ^ s5[zi(10, z)]^s6[zi( 9, z)]^s7[zi(11, z)]^s8[zi( 8, z)]^s6[xi(11, x)];
			k[8] = s5[zi( 3, z)]^s6[zi( 2, z)]^s7[zi(12, z)]^s8[zi(13, z)]^s5[zi( 9, z)];
			k[9] = s5[zi( 1, z)]^s6[zi( 0, z)]^s7[zi(14, z)]^s8[zi(15, z)]^s6[zi(12, z)];
			k[10]= s5[zi( 7, z)]^s6[zi( 6, z)]^s7[zi( 8, z)]^s8[zi( 9, z)]^s7[zi( 2, z)];
			k[11]= s5[zi( 5, z)]^s6[zi( 4, z)]^s7[zi(10, z)]^s8[zi(11, z)]^s8[zi( 6, z)];
			
			x[0] = z[2] ^ s5[zi( 5, z)]^s6[zi( 7, z)]^s7[zi( 4, z)]^s8[zi( 6, z)]^s7[zi( 0, z)];
			x[1] = z[0] ^ s5[xi( 0, x)]^s6[xi( 2, x)]^s7[xi( 1, x)]^s8[xi( 3, x)]^s8[zi( 2, z)];
			x[2] = z[1] ^ s5[xi( 7, x)]^s6[xi( 6, x)]^s7[xi( 5, x)]^s8[xi( 4, x)]^s5[zi( 1, z)];
			x[3] = z[3] ^ s5[xi(10, x)]^s6[xi( 9, x)]^s7[xi(11, x)]^s8[xi( 8, x)]^s6[zi( 3, z)];
			k[12]= s5[xi( 8, x)]^s6[xi( 9, x)]^s7[xi( 7, x)]^s8[xi( 6, x)]^s5[xi( 3, x)];
			k[13]= s5[xi(10, x)]^s6[xi(11, x)]^s7[xi( 5, x)]^s8[xi( 4, x)]^s6[xi( 7, x)];
			k[14]= s5[xi(12, x)]^s6[xi(13, x)]^s7[xi( 3, x)]^s8[xi( 2, x)]^s7[xi( 8, x)];
			k[15]= s5[xi(14, x)]^s6[xi(15, x)]^s7[xi( 1, x)]^s8[xi( 0, x)]^s8[xi(13, x)];
